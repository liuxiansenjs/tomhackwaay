...
function Waterfall (options) {
	...
	this._initialWidth = this._$items.outerWidth();
	this.initialize();
	this.render();
...
Waterfall.prototype.initialize = function() {
	if (this._$items.outerWidth() > this._$container.outerWidth()) {
		this._$items.css({width: this._$container.outerWidth()});
	}
	...
	if (this._grids > 1) {
		this._$items.css({width: this._initialWidth});
		this._$waterfall.css({width: (this._$items.outerWidth() + this._marginX) * this._grids});
	}
	this._model = [];
